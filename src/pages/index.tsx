  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless logistics with WAAHAN - your ultimate Warehouse and 1 Delhivery Application, revolutionizing the way you manage and track deliveries."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1553413077-190dd305871c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx3YXJlaG91c2V8ZW58MHx8fHwxNjkwMTQzNTUxfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless logistics with WAAHAN - your ultimate Warehouse and 1 Delhivery Application, revolutionizing the way you manage and track deliveries.`}
            </Text>
            <Box
